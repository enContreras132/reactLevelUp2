...
const API_URL = 'https://levelupapi-production.up.railway.app/audifono';
const Soloaudifonos = () => {
    ...
    return(
        <div style={{ padding: '20px', marginTop: '20px'}}>
            <h2 className="text-center mb-4">Catálogo actual de Audífonos</h2>
            ...
            {productos.length > 0 ? (
                ...
                <p className="text-center text-muted">No hay audífonos disponibles</p>
            )}
        </div>
    )
}
export default Soloaudifonos;
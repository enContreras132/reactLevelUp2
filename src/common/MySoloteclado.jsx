...
const API_URL = 'https://levelupapi-production.up.railway.app/teclado';
const Soloteclado = () => {
    ...
    return(
        <div style={{ padding: '20px', marginTop: '20px'}}>
            <h2 className="text-center mb-4">Catálogo actual de Teclados</h2>
            ...
            {productos.length > 0 ? (
                ...
                <p className="text-center text-muted">No hay teclados disponibles</p>
            )}
        </div>
    )
}
export default Soloteclado;
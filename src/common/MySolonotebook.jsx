...
const API_URL = 'https://levelupapi-production.up.railway.app/notebook';
const Solonotebook = () => {
    ...
    return(
        <div style={{ padding: '20px', marginTop: '20px'}}>
            <h2 className="text-center mb-4">Catálogo actual de Notebooks</h2>
            ...
            {productos.length > 0 ? (
                        ...
                        <tbody>
                            {productos.map((producto, index) => {
                                ...
                                <tr key={producto.id || index}>
                                    ...
                                    <td>{producto.procesador || 'N/A'}</td>
                                    <td>{producto.ram || 'N/A'}</td>
                ...
                <p className="text-center text-muted">No hay notebooks disponibles</p>
            )}
        </div>
    )
}
export default Solonotebook;